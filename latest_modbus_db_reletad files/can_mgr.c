...
extern MAX_MIN_PARAMTER_UNION Sec_Max_Min;
...
unsigned char wMboard_Fw_Ver[16] = {'M','-','0','6',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '};
...
int main()
{
	...
	*/ 
	...
	else
	{
		...
		{		
			alarm_cnfg[j] = atoi(alarm_cnfg_buffer);
			printf("alarm_cnfg[%d] = atoi(alarm_cnfg_buffer): %d = %d",j,alarm_cnfg[j] ,atoi(alarm_cnfg_buffer));
...
//			{
				if((Offset == 23))
				{
					...
					*(map + Offset) = (kVAr & 0xFFFF);
					...
					Data.word.Sys.sec_total_parameters[2] = ((unsigned long)(0x11E << 16))|((total_SEC_KW&0xFFFF));
					Data.word.Sys.sec_total_parameters[3] = ((unsigned long)(0x11F << 16))|((total_SEC_KVA&0xFFFF));
					Data.word.Sys.sec_total_parameters[4] = ((unsigned long)(0x120 << 16))|((total_SEC_KVAR&0xFFFF));
	...
	switch (reg)
	  {
		...
		case SEC: 
		{
		  ...
		  if (((Sec_Max_Min.word.Max_Volt_PhaseA & 0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF)) || ((Sec_Max_Min.word.Max_Volt_PhaseA & 0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Volt_PhaseA = (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[0] = ((unsigned long)(0x110 << 16))|(( Data.word.Secondary.L2N_Volt_Phase_A &0xFFFF));
		
		  }
		  if (((Sec_Max_Min.word.Max_Volt_PhaseB&0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF)) || ((Sec_Max_Min.word.Max_Volt_PhaseB&0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Volt_PhaseB = (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[1] = ((unsigned long)(0x111 << 16))|((Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF));
			
			
		  }
		  if (((Sec_Max_Min.word.Max_Volt_PhaseC&0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF)) || ((Sec_Max_Min.word.Max_Volt_PhaseC&0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Volt_PhaseC = (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[2] = ((unsigned long)(0x112 << 16))|((Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF));
			
			
		  }
		  if (((Sec_Max_Min.word.Min_Volt_PhaseA&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF)) || ((Sec_Max_Min.word.Min_Volt_PhaseA&0xFFFF) == 0))
	  	  {
		    Sec_Max_Min.word.Min_Volt_PhaseA = (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF);
		    Data.word.Sys.sec_max_min_parameters[3] = ((unsigned long)(0x113 << 16))|((Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF));
		    
		    
		  }
		  if (((Sec_Max_Min.word.Min_Volt_PhaseB&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF)) || ((Sec_Max_Min.word.Min_Volt_PhaseB&0xFFFF) == 0))
		  {
			Sec_Max_Min.word.Min_Volt_PhaseB = (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[4] = ((unsigned long)(0x114 << 16))|((Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF));
			
			
		  }
		  if (((Sec_Max_Min.word.Min_Volt_PhaseC&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF)) || ((Sec_Max_Min.word.Min_Volt_PhaseC&0xFFFF) == 0))
		  {
			Sec_Max_Min.word.Min_Volt_PhaseC = (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[5] = ((unsigned long)(0x115 << 16))|((Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF));

		  }
		  if (((Sec_Max_Min.word.Max_Curr_PhaseA&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF)) || ((Sec_Max_Min.word.Max_Curr_PhaseA&0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Curr_PhaseA = (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[6] = ((unsigned long)(0x116 << 16))|((Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF));
			
		  }
		  if (((Sec_Max_Min.word.Max_Curr_PhaseB&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Sec_Max_Min.word.Max_Curr_PhaseB&0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Curr_PhaseB = (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[7] = ((unsigned long)(0x117 << 16))|((Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF));
			
		  }
		  if (((Sec_Max_Min.word.Max_Curr_PhaseC&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF)) || ((Sec_Max_Min.word.Max_Curr_PhaseC&0xFFFF) == 0xFFFF))
		  {
			Sec_Max_Min.word.Max_Curr_PhaseC = (Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[8] = ((unsigned long)(0x118 << 16))|((Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF));
			
		  }
		  if (((Sec_Max_Min.word.Min_Curr_PhaseA&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF)) || ((Sec_Max_Min.word.Min_Curr_PhaseA&0xFFFF) == 0))
		  {
			Sec_Max_Min.word.Min_Curr_PhaseA = (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[9] = ((unsigned long)(0x119 << 16))|((Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF));
			
		  }
		  if (((Sec_Max_Min.word.Min_Curr_PhaseB&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Sec_Max_Min.word.Min_Curr_PhaseB&0xFFFF) == 0))
		  {
			Sec_Max_Min.word.Min_Curr_PhaseB = (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[10] = ((unsigned long)(0x11A << 16))|((Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF));
		  }
		  if (((Sec_Max_Min.word.Min_Curr_PhaseC&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Sec_Max_Min.word.Min_Curr_PhaseC&0xFFFF) == 0))	
		  {
			Sec_Max_Min.word.Min_Curr_PhaseC = (Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF);
			Data.word.Sys.sec_max_min_parameters[11] = ((unsigned long)(0x11B << 16))|((Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF));
	...
	switch (reg)
	{
	  ...
	  case SEC:
		...
		*(map + PRIMARY_OFFSET + 14) = kw_dwCalcBuff[3].word[1];
		...
		Data.word.Sys.sec_total_parameters[0] = ((unsigned long)(0x11C << 16))|((kw_dwCalcBuff[6].word[0]&0xFFFF));
		Data.word.Sys.sec_total_parameters[1] = ((unsigned long)(0x11D << 16))|((kw_dwCalcBuff[6].word[1]&0xFFFF));	
