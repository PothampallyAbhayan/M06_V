...
MAX_MIN_PARAMTER_UNION  Sec_Max_Min;
...
typedef struct
{
	...
	/*** Added for new sec requirement 22/12/22 ***/
	unsigned int sec_max_min_parameters[12];		//0x110 to 11B
	unsigned int sec_total_parameters[5];		//0x11C to 0x120 
	unsigned int PDC_ID;                        //0X121	
	
	unsigned int wSerial_Num[2];
