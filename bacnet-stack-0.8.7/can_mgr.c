...
unsigned char wMboard_Fw_Ver[16] = {'M','-','0','6','A',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '};
...
//			{
				if((Offset == 23))
				{
					...
					*(map + Offset) = (kVAr & 0xFFFF);
					...
					Data.word.Sys.sec_KVAR = (total_SEC_KVAR&0xFFFF);
...
void transmit_pkt(void )
{
	...
	*/
	...
	printf("\n Data.word.Sys.sec_KWH_Lo = %d",  Data.word.Sys.sec_KWH_Lo);
	printf("\n Data.word.Sys.sec_KWH_Hi = %d", Data.word.Sys.sec_KWH_Hi);
	printf("\n Data.word.Sys.sec_KW = %d",  Data.word.Sys.sec_KW);
	printf("\n Data.word.Sys.sec_KVA = %d",  Data.word.Sys.sec_KVA);
	printf("\n Data.word.Sys.sec_KVAR = %d", Data.word.Sys.sec_KVAR);
