 ...
 * Date      : 29/01/2019
 *
 * Copyright Infinicomm Solutions Pvt Ltd, 2019-20
 *
 ****************************************************************************************
 */
...
/*
 * Perform any DB specific commands using this API.
 */
extern int icos_mbusdb_perform_cmd(NOS_DB_HANDLE  *handle, char *cmd);
 ...
 *     reg_type
 */
extern icos_int16 icos_mbusdb_create_reg_interface( NOS_DB_HANDLE *p_hndl, icos_uint32 if_index,
		icos_int32 bus_no, icos_int16 slave_id, icos_int32 reg_addr, icos_int16 reg_type);
 ...
 *     reg_value
 */
extern int icos_mbusdb_update_reg( NOS_DB_HANDLE *p_hndl, icos_uint32 if_index, icos_uint32 reg_value);

extern int icos_mbusdb_bulk_update_reg( NOS_DB_HANDLE *p_hndl, icos_uint32 *p_if_index,
                                               icos_uint32  *p_reg_value, icos_uint32 reg_count);
...
extern icos_int32 icos_mbusdb_read_reg_data ( NOS_DB_HANDLE *p_hndl, icos_uint32 if_index, 
                                              icos_uint16   *reg_data);
...
extern icos_int32 icos_mbusdb_read_reg_data_from_address ( NOS_DB_HANDLE *p_hndl, icos_int16 bus_no,
        icos_int16 slave_id, icos_int32 reg_addr, icos_int32 reg_no,
        icos_int16 reg_width, icos_uchar **reg_data);
