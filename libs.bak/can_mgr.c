...
//			{
				if((Offset == 23))
				{
					...
					*(map + Offset) = (kVAr & 0xFFFF);
					...
					Data.word.Sys.sec_total_parameters[2] = ((unsigned long)(0x11C << 16))|((total_SEC_KW&0xFFFF));
					Data.word.Sys.sec_total_parameters[3] = ((unsigned long)(0x11D << 16))|((total_SEC_KVA&0xFFFF));
					Data.word.Sys.sec_total_parameters[4] = ((unsigned long)(0x11E << 16))|((total_SEC_KVAR&0xFFFF));
	...
	switch (reg)
	  {
		...
		case SEC: 
		{
          ...
          if (((Data.word.Max_Min_Para[1].Max_Volt_PhaseA & 0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Volt_PhaseA & 0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Volt_PhaseA = ((unsigned long)(0xA20 << 16))|((Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF));
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Max_Volt_PhaseB&0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Volt_PhaseB&0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Volt_PhaseB = ((unsigned long)(0xA21 << 16))|((Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF));
			
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Max_Volt_PhaseC&0xFFFF) < (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Volt_PhaseC&0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Volt_PhaseC = ((unsigned long)(0xA22 << 16))|((Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF));
			
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Volt_PhaseA&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Volt_PhaseA&0xFFFF) == 0))
	  	  {
		    Data.word.Max_Min_Para[1].Min_Volt_PhaseA = ((unsigned long)(0xA23 << 16))|((Data.word.Secondary.L2N_Volt_Phase_A&0xFFFF));
		    
		    
		    
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Volt_PhaseB&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Volt_PhaseB&0xFFFF) == 0))
		  {
			Data.word.Max_Min_Para[1].Min_Volt_PhaseB = ((unsigned long)(0xA24 << 16))|((Data.word.Secondary.L2N_Volt_Phase_B&0xFFFF));
			
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Volt_PhaseC&0xFFFF) > (Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Volt_PhaseC&0xFFFF) == 0))
		  {
			Data.word.Max_Min_Para[1].Min_Volt_PhaseC = ((unsigned long)(0xA25 << 16))|((Data.word.Secondary.L2N_Volt_Phase_C&0xFFFF));
			

		  }
		  if (((Data.word.Max_Min_Para[1].Max_Curr_PhaseA&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Curr_PhaseA&0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Curr_PhaseA = ((unsigned long)(0xA26 << 16))|((Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF));
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Max_Curr_PhaseB&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Curr_PhaseB&0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Curr_PhaseB = ((unsigned long)(0xA27 << 16))|((Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF));
			
		  }
		  if (((Data.word.Max_Min_Para[1].Max_Curr_PhaseC&0xFFFF) < (Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF)) || ((Data.word.Max_Min_Para[1].Max_Curr_PhaseC&0xFFFF) == 0xFFFF))
		  {
			Data.word.Max_Min_Para[1].Max_Curr_PhaseC = ((unsigned long)(0xA28 << 16))|((Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF));
			
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Curr_PhaseA&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Curr_PhaseA&0xFFFF) == 0))
		  {
			Data.word.Max_Min_Para[1].Min_Curr_PhaseA = ((unsigned long)(0xA2A << 16))|((Data.word.Secondary.RMS_Curr_Phase_A&0xFFFF));
			
			
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Curr_PhaseB&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Curr_PhaseB&0xFFFF) == 0))
		  {
			Data.word.Max_Min_Para[1].Min_Curr_PhaseB = ((unsigned long)(0xA2B << 16))|((Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF));
			
		  }
		  if (((Data.word.Max_Min_Para[1].Min_Curr_PhaseC&0xFFFF) > (Data.word.Secondary.RMS_Curr_Phase_B&0xFFFF)) || ((Data.word.Max_Min_Para[1].Min_Curr_PhaseC&0xFFFF) == 0))	
		  {
			Data.word.Max_Min_Para[1].Min_Curr_PhaseC = ((unsigned long)(0xA2C << 16))|((Data.word.Secondary.RMS_Curr_Phase_C&0xFFFF));
	...
	switch (reg)
	{
	  ...
	  case SEC:
		...
		*(map + PRIMARY_OFFSET + 14) = kw_dwCalcBuff[3].word[1];
		...
		Data.word.Sys.sec_total_parameters[0] = ((unsigned long)(0x11A << 16))|((kw_dwCalcBuff[6].word[0]&0xFFFF));
		Data.word.Sys.sec_total_parameters[1] = ((unsigned long)(0x11B << 16))|((kw_dwCalcBuff[6].word[1]&0xFFFF));	
...
static void icos_test_adc(int addr, int channel)
{
	...
	while(1) 
	{
		...
		printf("\n (alarm_cnfg_1>>10)&0x01) = %d", (alarm_cnfg_1>>10)&0x01));
		
		if(no_xfmr && ((alarm_cnfg_1>>10)&0x01))   
		{
			for(i = 0;i < fan_num;i++)
			{
				adc_flag = 1;
